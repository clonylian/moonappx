      ...
      <div v-if="isOverlayVisible" class="overlay">
        <div class="zzcdiv">
          ...
          <div class="zzcdivt">
            ...
            <div class="zzcdx">
              <div @click="choosetaby('0')" :class="filterraby == '0' ? 'zzcdone zzcdchover' : 'zzcdone'">
                {{ $store.state.txt.connecttcly.one }}
              </div>
              <div @click="choosetaby('1')" :class="filterraby == '1' ? 'zzcdone zzcdchover' : 'zzcdone'">
                {{ $store.state.txt.connecttcly.two }}
              </div>
              <div @click="choosetaby('2')" :class="filterraby == '2' ? 'zzcdone zzcdchover' : 'zzcdone'">
                {{ $store.state.txt.connecttcly.three }}
              </div>
              <div @click="choosetaby('3')" :class="filterraby == '3' ? 'zzcdone zzcdchover' : 'zzcdone'">
          ...
          <div class="zzcdivt">
            <p>{{ $store.state.txt.homethrtype }}</p>
            <div class="zzcdxt">
              <div @click="choosetabt('0')" :class="filterrabt == '0' ? 'zzcdone zzcdchover' : 'zzcdone'">
                {{ $store.state.txt.connecttclt.one }}
              </div>
              <div @click="choosetabt('1')" :class="filterrabt == '1' ? 'zzcdone zzcdchover' : 'zzcdone'">
                {{ $store.state.txt.connecttclt.two }}
              </div>
              <div @click="choosetabt('2')" :class="filterrabt == '2' ? 'zzcdone zzcdchover' : 'zzcdone'">
                {{ $store.state.txt.connecttclt.three }}
              </div>
              <div @click="choosetabt('3')" :class="filterrabt == '3' ? 'zzcdone zzcdchover' : 'zzcdone'">
                {{ $store.state.txt.connecttclt.four }}
              </div>
              <div @click="choosetabt('4')" :class="filterrabt == '4' ? 'zzcdone zzcdchover' : 'zzcdone'">
                {{ $store.state.txt.connecttclt.five }}
              </div>
              <div @click="choosetabt('5')" :class="filterrabt == '5' ? 'zzcdone zzcdchover' : 'zzcdone'">
          ...
          <div class="zzcdivt">
            ...
            <div class="zzc_rli">
              <input ref="dateInput" v-model="selectedDateString" placeholder="DD/MM/YYY" />
              <svg @click="dakai" style="width: 25px; height: 25px; margin-right: 1rem; "
